...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN 151                  // Override the default pin if needed
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define NEO2_USER_PRESET_BLUE        64  // User defined BLUE value
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MAX_ARC_SEGMENT_MM      0.5 // (mm) Maximum length of each arc segment
  #define MIN_CIRCLE_SEGMENTS    96   // Minimum number of segments in a complete circle
